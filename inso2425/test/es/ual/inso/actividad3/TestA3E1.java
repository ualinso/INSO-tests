...
public class TestA3E1 {
  ...
  private static Behavior consultarStockPieza;  
  private static Vector<String> lld1;
  private static Vector<String> coveredLoopD1;
  
  private static Behavior revisarUltimaFicha;
    ...
    for (PackageableElement pe : model.getPackagedElements()) {
      ...
      if (pe instanceof org.eclipse.uml2.uml.Collaboration) {
        ...
        for (Behavior ob : colab.getOwnedBehaviors()) {
          ...
          if (dseName.equalsIgnoreCase("consultarStockPieza")) {
            consultarStockPieza = ob;
            loadConsultarStockPieza(ob);

          }
          
          if (dseName.equalsIgnoreCase("revisarUltimaFicha")) {
            revisarUltimaFicha = ob;
            loadRevisarUltimaFicha(ob);
  ...
  private static void loadConsultarStockPieza(org.eclipse.uml2.uml.Behavior dse) {
...
//        }
  ...
  private static void loadRevisarUltimaFicha(org.eclipse.uml2.uml.Behavior dse) {
...
//        }
  ...
  public void testDiagramasDeSecuencia() {
    ...
    assertNotEquals("No existe el diagrama 'consultarStockPieza'.", consultarStockPieza, null);
    assertNotEquals("No existe el diagrama 'revisarUltimaFicha'.", revisarUltimaFicha, null);

  }

  @Test
  public void testLifeLinesConsultarStockPieza() {
    if (consultarStockPieza != null) {
      boolean ll1 = lld1.contains("Taller");
      boolean ll2= lld1.contains("Pieza");
      assertTrue("La clase Taller no está bien representada en 'consultarStockPieza'.", ll1);
      assertTrue("La clase Pieza no está bien representada en 'consultarStockPieza'.", ll2);
    }
  }
  
  @Test
  public void testLifeLinesRevisarUltimaFicha() {
    if (revisarUltimaFicha != null) {
      boolean ll1 = lld2.contains("Mecanico");
      boolean ll2= lld2.contains("Coche");
      boolean ll3= lld2.contains("Ficha");
      assertTrue("La clase Mecanico no está bien representada en 'revisarUltimaFicha'.", ll1);
      assertTrue("La clase Coche no está bien representada en 'revisarUltimaFicha'.", ll2);
      assertTrue("La clase Ficha no está bien representada en 'revisarUltimaFicha'.", ll3);
    }
  }

  @Test
  public void testLoop1ConsultarStockPieza() {
    if (consultarStockPieza != null) {
      boolean ll1 = coveredLoopD1.contains("Taller");
      boolean ll2 = coveredLoopD1.contains("Pieza");
      assertTrue("El bucle principal no abarca correctamente la clase Taller en 'consultarStockPieza'.", ll1);
      assertTrue("El bucle principal no abarca correctamente la clase Pieza en 'consultarStockPieza'.", ll2);
    }
  }
  
  @Test
  public void testLoop1RevisarUltimaFicha() {
    if (revisarUltimaFicha != null) {
      boolean ll1 = coveredLoopD2.contains("Mecanico");
      boolean ll2 = coveredLoopD2.contains("Coche");
      boolean ll3 = coveredLoopD2.contains("Ficha");
      assertTrue("El bucle principal no abarca correctamente la clase Mecanico en 'revisarUltimaFicha'.", ll1);
      assertTrue("El bucle principal no abarca correctamente la clase Jugador en 'revisarUltimaFicha'.", ll2);
      assertTrue("El bucle principal no abarca correctamente la clase Objeto en 'revisarUltimaFicha'.", ll3);
    }
  }
