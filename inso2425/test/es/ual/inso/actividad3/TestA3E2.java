...
public class TestA3E2 {
  ...
  private static Behavior crearRecomendacion;
    ...
    for (PackageableElement pe : model.getPackagedElements()) {
      ...
      if (pe instanceof org.eclipse.uml2.uml.Collaboration) {
        ...
        for (Behavior ob : colab.getOwnedBehaviors()) {
          ...
          if (dseName.equalsIgnoreCase("crearRecomendacion")) {
            crearRecomendacion = ob;
            loadCrearRecomendacion(ob);
  ...
  private static void loadCrearRecomendacion(org.eclipse.uml2.uml.Behavior dse) {
...
//        }
  ...
  @Test
  public void testLifeLinesCrearRecomendacion() {
    if (crearRecomendacion != null) {
      boolean ll1 = lld1.contains("RedSocial");
      boolean ll2 = lld1.contains("Libro");
      boolean ll3 = lld1.contains("Recomendacion");
      assertTrue("La clase RedSocial no está bien representada en 'crearRecomendacion'.", ll1);
      assertTrue("La clase Libro no está bien representada en 'crearRecomendacion'.", ll2);
      assertTrue("La clase Recomendacion no está bien representada en 'crearRecomendacion'.", ll3);
    }
  }
  ...
  @Test
  public void testLoop1CrearRecomendacion() {
    if (crearRecomendacion != null) {
      boolean ll1 = coveredLoopD1.contains("RedSocial");
      boolean ll2 = coveredLoopD1.contains("Libro");
      boolean ll3 = coveredLoopD1.contains("Recomendacion");
      assertTrue("El bucle principal no abarca correctamente la clase RedSocial en 'crearRecomendacion'.", ll1);
      assertTrue("El bucle principal no abarca correctamente la clase Libro en 'crearRecomendacion'.", ll2);
      assertTrue("El bucle principal no abarca correctamente la clase Recomendacion en 'crearRecomendacion'.", ll3);
    }
  }
