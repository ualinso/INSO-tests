...
public class TestA3E2 {
  ...
  private static Behavior comprarSobres;
  private static Vector<String> lld1;
  private static Vector<String> coveredLoopD1;

  private static Behavior agruparCartasPorRareza;
...
//    Resource resource = resSet.getResource(fileURI, true);
    ...
    for (PackageableElement pe : model.getPackagedElements()) {
      ...
      if (pe instanceof org.eclipse.uml2.uml.Collaboration) {
        ...
        for (Behavior ob : colab.getOwnedBehaviors()) {
          ...
          if (dseName.equalsIgnoreCase("comprarSobres")) {
            comprarSobres = ob;
            loadComprarSobres(ob);

          }

          if (dseName.equalsIgnoreCase("agruparCartasPorRareza")) {
            agruparCartasPorRareza = ob;
            loadAgruparCartasPorRareza(ob);
  ...
  private static void loadComprarSobres(org.eclipse.uml2.uml.Behavior dse) {
...
//        }
  ...
  private static void loadAgruparCartasPorRareza(org.eclipse.uml2.uml.Behavior dse) {
...
//        }
  ...
  public void testDiagramasDeSecuencia() {
    ...
    assertNotEquals("No existe el diagrama 'comprarSobres'.", comprarSobres, null);
    assertNotEquals("No existe el diagrama 'agruparCartasPorRareza'.", agruparCartasPorRareza, null);

  }

  @Test
  public void testLifeLinesComprarSobres() {
    if (comprarSobres != null) {

      String dseName = "comprarSobres";
      String ll1Name = "Duelista";
      String ll2Name = "Coleccion";
  ...
  @Test
  public void testLifeLinesAgruparCartasPorRareza() {
    if (agruparCartasPorRareza != null) {

      String dseName = "agruparCartasPorRareza";
      String ll1Name = "Duelista";
      String ll2Name = "CartaDuelista";
